...
HTTP server for evaluating [Mangle](https://github.com/google/mangle) programs. Wraps the Rust `mangle-driver` compilation and execution pipeline behind a JSON API.
